  ...
  pt: {
    ...
    feedback: {
      ...
      form: {
        ...
        message: "Feedback",
        messagePlaceholder:
          "Deixe seu comentario sobre como foi trabalhar comigo ou o que achou de um dos meus projetos...",
  ...
  en: {
    ...
    feedback: {
      ...
      form: {
        ...
        message: "Feedback",
        messagePlaceholder:
          "Leave your comment about what it was like working with me or what you thought of one of my projects...",
  ...
  es: {
    ...
    feedback: {
      ...
      form: {
        ...
        message: "Feedback",
        messagePlaceholder:
          "Deja tu comentario sobre cómo fue trabajar conmigo o qué te pareció uno de mis proyectos...",
        submit: "Enviar feedback",
        sending: "Enviando...",
      },
      errors: {
  ...
  de: {
    ...
    feedback: {
      ...
      form: {
        ...
        message: "Feedback",
        messagePlaceholder:
          "Hinterlasse deinen Kommentar dazu, wie es war, mit mir zu arbeiten, oder was du von einem meiner Projekte gehalten hast...",
  ...
  it: {
    ...
    feedback: {
      ...
      form: {
        ...
        message: "Feedback",
        messagePlaceholder:
          "Lascia il tuo commento su com'è stato lavorare con me o su cosa ne pensi di uno dei miei progetti...",
